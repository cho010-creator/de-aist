...
HTML_DIR = os.path.join(os.path.dirname(__import streamlit as st
import streamlit.components.v1 as components
import os
...
if not pages:
    ...
    # 요청하신 순서대로 페이지 목록을 직접 정의하고 새 페이지를 추가합니다.
    ordered_page_names = [
        "팝업 스토어 성공 예측 모델",
        "실시간 재난 대응 대시보드",
        "연금술사 카드게임 시연",
        "Ai 주간 학습 계획 생성기",
        "키보드 입력 메트릭스 AI 분석" # 새 페이지를 목록에 포함
    ]
    ...
    if not os.path.exists(selected_file_path):
        ...
        # height를 더 늘려 긴 보고서도 스크롤 없이 볼 수 있도록 했습니다.
